...
<div class="content-wrapper">
    <div class="row">
        <div class="col-md-12 grid-margin transparent">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Tambah Kategori Menu</h4>
...
<script>
    $(document).ready(function () {
        var menu = window.location.pathname.split('/')[2];
        var formattedTitle = menu.split('-').map(word => word.charAt(0).toUpperCase() + word.slice(1)).join(' ');
        ...
        $.ajax({
            ...
            success: function(data) {
                data.menu.forEach(function(menu) {
                    if(menu.nama_menu == formattedTitle){
                        $('#index-menu').val(menu.id);
                    }
                });
            },
