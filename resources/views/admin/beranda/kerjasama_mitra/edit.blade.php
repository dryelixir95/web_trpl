...
<script>
    $(document).ready(function () {
        var mitraId = window.location.pathname.split('/').pop();

        $.ajax({
            url: '/api/admin/kerjasama-mitra/edit/' + mitraId,
            method: 'GET',
            success: function(data) {
                if(data.status === "success") {
                    $('#nama_mitra').val(data.mitra.nama_mitra);
                    $('#alamat_mitra').val(data.mitra.alamat_mitra);
                    if (data.mitra.logo_mitra) {
                        var previewHtml = '<img src="/images/mitra/' + data.mitra.logo_mitra + '" class="img-fluid">';
