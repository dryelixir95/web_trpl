...
<div class="content-wrapper">
    <div class="row">
        <div class="col-md-12 grid-margin transparent">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Tambah Akreditasi</h4>
                        ...
                        <div class="row">
                            <div class="col mb-3">
                                ...
                                <input type="file" class="form-control-file" id="file_akreditasi" name="file_akreditasi" accept=".jpg,.jpeg,.png,.pdf" required>
