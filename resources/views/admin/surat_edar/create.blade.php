...
<div class="content-wrapper">
    <div class="row">
        <div class="col-md-12 grid-margin transparent">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Tambah Surat Edar Mahasiswa Baru</h4>
                        <form id="StoreForm" enctype="multipart/form-data" method="POST">
                        @csrf
                        <div class="row">
                            <div class="col mb-3">
                                <label for="nama_surat_edar" class="form-label">Nama Surat Edar</label>
                                <input type="text" class="form-control" id="nama_surat_edar" name="nama_surat_edar" required>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col mb-3">
                        ...
                        <div class="row">
                            <div class="col mb-3">
                                <label for="file_surat_edar" class="form-label">Unggah file PDF/XLS</label>
                                <input type="file" class="form-control-file" id="file_surat_edar" name="file_surat_edar" accept=".xls,.xlsx,.pdf" required>
...
<script>
    $(document).ready(function () {
        ...
        $('#file_surat_edar').change(function() {
        ...
        $('#StoreForm').submit(function(event) {
            ...
            formData.append('nama_surat_edar', $('#nama_surat_edar').val());
            formData.append('keterangan', $('#keterangan').val());
            
            if ($('#file_surat_edar')[0].files[0]) {
                formData.append('file_surat_edar', $('#file_surat_edar')[0].files[0]);
            }
