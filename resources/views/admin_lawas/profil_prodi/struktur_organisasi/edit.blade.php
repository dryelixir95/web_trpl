                    ...
                    <h4 class="card-title">Edit Struktur Organisasi</h4>
                        ...
                        <div class="row">
                            <div class="col mb-3">
                                ...
                                <input type="file" class="form-control-file" id="file_struktur" name="file_struktur" accept=".jpg,.jpeg,.png,.pdf">
...
$(document).ready(function() {
    ...
    $.ajax({
        url: '/api/admin/struktur-organisasi', // Sesuaikan URL API Anda
        method: 'GET',
        success: function(data) {
            if(data.status === "success") {
                var strukturOrganisasi = data.strukturOrganisasi;

                $('#judul').val(strukturOrganisasi.judul);

                var fileUrl = strukturOrganisasi.file_struktur; // URL file
                ...
                if (['jpg', 'jpeg', 'png', 'gif'].includes(fileExtension)) {
                    ...
                    previewContent = '<img src="' + '/files/strukturOrganisasi/' + fileUrl + '" alt="Preview" class="img-fluid">';
                } else if (fileExtension === 'pdf') {
                    // Jika file PDF, buat elemen embed
                    previewContent = '<embed src="' + '/files/strukturOrganisasi/' + fileUrl + '" type="application/pdf" width="100%" height="400px">';
                } else {
                    // Jika file tipe lain, buat link untuk mengunduh
                    previewContent = '<a href="' + '/files/strukturOrganisasi/' + fileUrl + '" target="_blank">Lihat File</a>';
                }
    ...
    $('#UpdateForm').on('submit', function(event) {
        ...
        if ($('#file_struktur')[0].files.length > 0) {
