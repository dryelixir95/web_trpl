        ...
        <div class="row">
            ...
            <div class="col-md-6 mb-4">
                <div class="d-flex flex-column align-items-end">
                    <h3 style="margin-right: 6rem;">Kerjasama Mitra</h3>
                ...
                dataKerjasamaMitra.forEach(function(post) {
                    ...
                    if (imageUrls) {
                        imageUrls.forEach(function(imageUrl) {
                            ...
                            mitraLogos.push(`<img src="${url}" alt="${post.judul}" class="img-fluid mx-3 mt-3" style="height: 60px; border-radius: 10px;">`);
                        });
                    }
                });
